...
local function Shared(self, unit)
  ...
  health.value:SetPoint("RIGHT", health, -5, 1)
  health.value:SetFont(font2, 14, "THINOUTLINE")
  health.value:SetTextColor(1, 1, 1)
  health.value:SetShadowOffset(1, -1)
  health.value:SetShadowColor(0, 0, 0, .5)
  ...
  power:Point("TOPLEFT", health, "BOTTOMLEFT", 0, -T.Scale(1))
  power:Point("BOTTOMRIGHT", self, "BOTTOMRIGHT")
  ...
  name:SetPoint("LEFT", health, 5, 0)
  name:SetFont(font2, 14, "THINOUTLINE")
  name:SetShadowOffset(1, -1)
  name:SetShadowColor(0, 0, 0, 1)
  self:Tag(name, "[Tukui:namemedium][Tukui:afk]")
  self.Name = name
  ...
  health.Smooth = C["unitframes"].showsmooth
  ...
  castbar.Text:SetAlpha(.8)
  castbar.Text:SetPoint("CENTER")
  castbar.Text:SetFont(font2, 14, "THINOUTLINE")
  castbar.Text:SetTextColor(1, 1, 1)
  castbar.Text:SetShadowOffset(1, -1)
  castbar.Text:SetShadowColor(0, 0, 0, .5)
...
oUF:Factory(function(self)
  ...
  local raid = self:SpawnHeader(
    "TukuiRaidHealer15", nil, "custom [@raid16,exists] hide;show", 
    ...
    'initial-height', T.Scale(26*T.raidscale),  
    "showParty", true,
  ...
  pets[1]:Size(150*T.raidscale, 26*T.raidscale)

  for i =2, 4 do 
    pets[i] = oUF:Spawn('partypet'..i, 'oUF_TukuiPartyPet'..i) 
    pets[i]:SetPoint('TOP', pets[i-1], 'BOTTOM', 0, -3)
    pets[i]:Size(150*T.raidscale, 26*T.raidscale)
  end
